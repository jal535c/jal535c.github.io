const PATTERNS = [
  ...
  },
  {
    ...
    pattern: [
      ...
      ["pink", "pink", "blue", "yellow", "pink"],
      ["pink", "white", "pink", "blue", "blue"],
      ["blue", "yellow", "white", "pink", "blue"]
    ],
    attempts: 9
  },
  {
    id: 1035,
    pattern: [
      ["white", "white", "yellow", "white", "pink"],
      ["blue", "yellow", "blue", "pink", "white"],
      ["yellow", "blue", "pink", "blue", "white"],
      ["pink", "blue", "white", "white", "white"],
      ["white", "pink", "pink", "yellow", "yellow"]
    ],
    attempts: 9
  },
  {
    id: 1039,
    pattern: [
      ["white", "pink", "white", "yellow", "white"],
      ["white", "yellow", "yellow", "yellow", "blue"],
      ["yellow", "white", "white", "white", "pink"],
      ["yellow", "yellow", "blue", "yellow", "pink"],
      ["white", "blue", "blue", "pink", "pink"]
    ],
    attempts: 9
  },
  {
    id: 1040,
    pattern: [
      ["blue", "pink", "pink", "yellow", "white"],
      ["white", "pink", "yellow", "pink", "blue"],
      ["white", "blue", "white", "white", "pink"],
  ...
  },
  {
    ...
    pattern: [
      ...
      ["blue", "white", "yellow", "blue", "white"],
      ["blue", "white", "pink", "yellow", "pink"],
      ["white", "pink", "yellow", "pink", "yellow"],
      ["white", "yellow", "white", "white", "pink"]
    ],
    attempts: 9
  },
  {
    ...
    pattern: [
      ...
      ["yellow", "white", "yellow", "white", "pink"],
      ["yellow", "white", "white", "white", "pink"],
      ["white", "yellow", "pink", "yellow", "pink"],
      ["yellow", "white", "white", "pink", "yellow"]      
    ],
    attempts: 8
  },
  {
    ...
    pattern: [
      ...
      ["blue", "pink", "pink", "white", "yellow"],
      ["blue", "white", "blue", "yellow", "white"],
      ["pink", "blue", "yellow", "pink", "white"],
      ["yellow", "yellow", "pink", "white", "blue"]
    ],
    attempts: 10
  },
  {
    id: 1050,
    pattern: [
      ["pink", "yellow", "white", "yellow", "yellow"],
      ["pink", "blue", "yellow", "yellow", "yellow"],
      ["yellow", "white", "blue", "yellow", "white"],
      ["white", "blue", "yellow", "blue", "pink"],
      ["blue", "blue", "blue", "pink", "white"]
    ],
    attempts: 9
  },
  {
    id: 1051,
    pattern: [
      ["pink", "yellow", "pink", "pink", "pink"],
      ["yellow", "blue", "blue", "blue", "white"],
      ["blue", "blue", "blue", "yellow", "pink"],
      ["blue", "pink", "yellow", "white", "yellow"],
      ["pink", "yellow", "yellow", "white", "pink"]
    ],
    attempts: 8
  },
  {
    ...
    pattern: [
      ...
      ["pink", "blue", "white", "white", "white"],
      ["yellow", "blue", "yellow", "white", "pink"],
      ["yellow", "pink", "blue", "yellow", "yellow"],
  ...
  },
  {
    ...
    pattern: [
      ...
      ["yellow", "yellow", "pink", "yellow", "pink"],
      ["yellow", "pink", "yellow", "pink", "yellow"],
      ["pink", "pink", "white", "blue", "yellow"]
    ],
    attempts: 7
  },
  {
    id: 1058,
    pattern: [
      ["white", "white", "yellow", "pink", "blue"],
      ["white", "blue", "yellow", "pink", "pink"],
      ["blue", "yellow", "blue", "yellow", "yellow"],
      ["blue", "yellow", "white", "white", "white"],
      ["white", "white", "blue", "yellow", "yellow"]
    ],
    attempts: 8
  },
  {
  ...
  },
  {
    id: 414,
    pattern: [
      ["blue", "pink", "white", "pink", "pink"],
      ["white", "blue", "pink", "pink", "pink"],
      ["yellow", "white", "yellow", "blue", "blue"],
      ["blue", "yellow", "blue", "white", "blue"],
  ...
  },
  {
    id: 1070,
    pattern: [
      ["white", "blue", "blue", "yellow", "pink"],
      ["pink", "yellow", "blue", "yellow", "pink"],
      ["white", "yellow", "yellow", "yellow", "white"],
      ["blue", "white", "pink", "pink", "yellow"],
      ["pink", "white", "yellow", "yellow", "white"]
    ],
    attempts: 9
  },
  {
    ...
    pattern: [
      ...
      ["blue", "yellow", "pink", "yellow", "white"],
      ["blue", "pink", "yellow", "pink", "yellow"],
      ["yellow", "pink", "white", "blue", "pink"],
      ["yellow", "yellow", "pink", "white", "blue"]
    ],
    attempts: 9
  },
  {
    id: 1079, 
    pattern: [
      ["yellow", "yellow", "blue", "pink", "yellow"],
      ["pink", "pink", "pink", "blue", "white"],
      ["blue", "blue", "white", "yellow", "blue"],
      ["blue", "blue", "yellow", "blue", "white"],
      ["blue", "yellow", "pink", "blue", "blue"]
    ],
    attempts: 9
  },
  {
    ...
    pattern: [
      ...
      ["white", "white", "pink", "blue", "yellow"],
      ["yellow", "yellow", "yellow", "white", "pink"],
      ["yellow", "pink", "pink", "yellow", "blue"]
    ],
    attempts: 9
  },
  {
    id: 1096, 
    pattern: [
      ["yellow", "yellow", "pink", "blue", "white"],
      ["blue", "blue", "yellow", "yellow", "blue"],
      ["blue", "yellow", "blue", "pink", "pink"],
      ["pink", "white", "white", "yellow", "yellow"],
      ["pink", "blue", "white", "pink", "pink"]
    ],
    attempts: 9
  },
  {
    id: 1099, 
    pattern: [
      ["white", "pink", "white", "yellow", "pink"],
      ["yellow", "white", "yellow", "pink", "blue"],
      ["white", "yellow", "blue", "blue", "pink"],
      ["white", "yellow", "yellow", "pink", "blue"],
      ["white", "pink", "pink", "blue", "blue"]
    ],
    attempts: 9
  },
  {
    id: 1100, 
    pattern: [
      ["blue", "pink", "pink", "blue", "blue"],
      ["blue", "pink", "blue", "yellow", "white"],
      ["blue", "yellow", "pink", "white", "white"],
      ["blue", "blue", "blue", "pink", "yellow"],
  ...
  },
  {
    id: 1110,
    pattern: [
      ["white", "pink", "blue", "yellow", "blue"],
      ["blue", "pink", "pink", "blue", "blue"],
      ["pink", "yellow", "yellow", "yellow", "white"],
  ...
  },
  {
    id: 1122,
    pattern: [
      ["pink", "blue", "yellow", "pink", "yellow"],
      ["pink", "blue", "pink", "yellow", "yellow"],
      ["blue", "yellow", "yellow", "pink", "pink"],
      ["blue", "pink", "white", "white", "pink"],
  ...
  },
  {
    ...
    pattern: [
      ["pink", "pink", "pink", "blue", "blue"],
      ["pink", "blue", "blue", "blue", "white"],
      ["pink", "yellow", "yellow", "pink", "pink"],
      ["yellow", "white", "pink", "yellow", "blue"],
      ["blue", "yellow", "yellow", "white", "blue"]
    ],
    attempts: 9
  },
  {
  ...
  },
  {
    id: 1131,
    pattern: [
      ["blue", "white", "yellow", "pink", "white"],
      ["white", "yellow", "blue", "white", "white"],
      ["white", "blue", "pink", "yellow", "white"],
      ["blue", "blue", "white", "pink", "pink"],
      ["yellow", "pink", "pink", "blue", "pink"]      
    ],
    attempts: 8
  },
  {
    ...
    pattern: [
      ["blue", "pink", "pink", "white", "blue"],
      ["pink", "blue", "yellow", "white", "white"],
      ["pink", "white", "pink", "pink", "blue"],
      ["blue", "pink", "white", "white", "pink"],
      ["blue", "yellow", "yellow", "white", "white"]
    ],
    attempts: 9
  },
  {
    id: 1148,
    pattern: [
      ["pink", "pink", "yellow", "blue", "white"],
      ["white", "blue", "pink", "yellow", "white"],
      ["white", "white", "yellow", "yellow", "white"],
      ["pink", "blue", "white", "pink", "white"],
      ["pink", "white", "blue", "yellow", "blue"]
    ],
    attempts: 9
  }
